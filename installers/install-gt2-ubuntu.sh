...
pull_docker_images() {
    ...
    # Use x86 compose overlay
    local compose_cmd="docker compose -f docker-compose.yml -f docker-compose.x86.yml"
...
ExecStart=/usr/bin/docker compose -f docker-compose.yml -f docker-compose.x86.yml up -d
ExecStop=/usr/bin/docker compose -f docker-compose.yml -f docker-compose.x86.yml down
TimeoutStartSec=0
