      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Central configuration for all AI models across GT 2.0 clusters.
          </p>
        </div>
        ...
        <TabsContent value="registry" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage all AI models available across GT 2.0 clusters. Changes sync automatically. Use the delete option to permanently remove models.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ModelRegistryTable
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Manage API endpoints for model providers. Custom endpoints can be used when adding models.
                  </CardDescription>
                </div>
                <Button onClick={() => setShowEndpointDialog(true)} className="flex items-center gap-2">
                  <Plus className="w-4 h-4" />
                  Add Custom Endpoint
                </Button>
              </div>
            ...
            <CardContent>
              <EndpointConfigurator
                showAddDialog={showEndpointDialog}
                onShowAddDialogChange={setShowEndpointDialog}
              />
            </CardContent>
          </Card>
        </TabsContent>
