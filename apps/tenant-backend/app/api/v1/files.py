...
async def upload_file(
    ...
    try:
        ...
        logger.error(f"File upload failed for {file.filename if file and file.filename else 'unknown'}: {e}")
...
async def delete_file(
    ...
    try:
        ...
        logger.error(f"Delete file failed for {file_id}: {e}")
...
async def get_document_summary(
    ...
    try:
        ...
        logger.error(f"Document summary generation failed for {file_id}: {e}")
