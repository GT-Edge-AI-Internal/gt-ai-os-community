...
async def get_dataset(
    ...
    try:
        ...
        raise HTTPException(500, f"Failed to get dataset: {str(e)}")
...
async def get_dataset_summary(
    ...
    try:
        ...
        logger.error(f"Dataset summary generation failed for {dataset_id}: {e}")
...
async def update_dataset(
    ...
    try:
        ...
        raise HTTPException(500, f"Failed to update dataset: {str(e)}")
...
async def share_dataset(
    ...
    try:
        ...
        raise HTTPException(500, f"Failed to share dataset: {str(e)}")
...
async def get_dataset_stats(
    ...
    try:
        ...
        raise HTTPException(500, f"Failed to get dataset stats: {str(e)}")
...
async def get_agent_accessible_datasets(
    ...
    try:
        ...
        raise HTTPException(500, f"Failed to get agent accessible datasets: {str(e)}")
